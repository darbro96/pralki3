    ...
    <div class="row m-0">
        ...
        <div class="col-sm-9 col-md-10   padm shadow bg-light" id="content">
            <div class="p-1" id="title">
                ...
                <br>
                <div class="card">
                    <div class="card-header"><h5>Wyszukaj użytkownika do zakwaterowania
                        <span class="badge badge-warning"> ! </span><br>
                        <input type="text" ng-model="par" ng-change="search()"/></h5></div>
                    <div class="card-body">
                        <div class="table-responsive">
                            <table class="table table-striped">
                                ...
                                <tr data-ng-repeat="u in vUsers">
                                    ...
                                    <td>{{u.cardId}}</td>
                                    <td>
                                        <button ng-click="editUser(u.idUser)" ng-show="u.room==null" class="btn btn-outline-primary">
                                            Zakwateruj
                                        </button>&nbsp;
                                    </td>
                                </tr>
...
<script>
    angular.module('pralki', [  ]).controller('usersContr', function ($scope, $http, $location) {
        ...
        $scope.editUser = function (idUser) {
            window.location.href = '${pageContext.request.contextPath}/checkin/' + idUser;
        };
